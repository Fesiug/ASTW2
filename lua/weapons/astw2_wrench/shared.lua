...
SWEP.Purpose = "A bolt-tightening tool, which is heavy enough to be used to whack people, sometimes to death."
SWEP.Instructions = "ATTACK2 to aim. ATTACK1 to raise weapon, release to swing. Release ATTACK2 to cancel swing."

SWEP.ViewModel = nil
SWEP.WorldModel = "models/weapons/w_eq_wrench.mdl"
...
SWEP.Melee_HitHumanSound = "physics/body/body_medium_impact_hard3.wav"
