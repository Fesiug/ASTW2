...
SWEP.Purpose = "Snub-nosed P38 pistol. Worse accuracy than the normal P38, but has a slightly better fire rate."
SWEP.Instructions = "ATTACK2 to aim, ATTACK1 to fire. Uses 9mm ammo."

SWEP.ViewModel = nil
SWEP.WorldModel = "models/weapons/w_pist_p38s.mdl"

SWEP.Primary.Damage = 12
SWEP.Primary.Delay = 60 / 500
SWEP.Primary.Acc = 1 / 35
