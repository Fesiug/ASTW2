...
SWEP.Purpose = "A large two-handed hammer made for destroying walls, though it destroys unsuspecting victims just as well."
SWEP.Instructions = "ATTACK2 to aim. ATTACK1 to raise weapon, release to swing. Release ATTACK2 to cancel swing."

SWEP.ViewModel = nil
SWEP.WorldModel = "models/weapons/w_eq_sledgehammer.mdl"
...
SWEP.Melee_Range = 32 // Range of the melee attack trace.
SWEP.Melee_SwingTime = 0.5
SWEP.Melee_HitSound = "physics/concrete/concrete_block_impact_hard1.wav"
SWEP.Melee_HitHumanSound = "physics/body/body_medium_break3.wav"
