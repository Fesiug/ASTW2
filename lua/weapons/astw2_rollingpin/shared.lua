...
SWEP.Purpose = "A wooden device for rolling dough flat. Also good for whacking."
SWEP.Instructions = "ATTACK2 to aim. ATTACK1 to raise weapon, release to swing. Release ATTACK2 to cancel swing."

SWEP.ViewModel = nil
SWEP.WorldModel = "models/weapons/w_eq_rollingpin.mdl"
...
SWEP.Melee_HitSound = "physics/wood/wood_solid_impact_hard3.wav"
SWEP.Melee_HitHumanSound = "physics/body/body_medium_impact_hard2.wav"
