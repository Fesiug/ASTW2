...
SWEP.Purpose = "The AR-10 was invented by Eugene Stoner as a 7.62 calibre version of the AR-15 rifle."
SWEP.Instructions = "ATTACK2 to aim, ATTACK1 to fire. Uses 7.62mm ammo."

SWEP.ViewModel = nil
SWEP.WorldModel = "models/weapons/w_rif_ar10.mdl"

SWEP.Primary.Damage = 24
SWEP.Primary.Delay = 60 / 700
SWEP.Primary.Acc = 1 / 175
