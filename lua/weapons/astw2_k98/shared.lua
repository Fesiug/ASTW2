...
SWEP.Purpose = "Bolt action carbine used by the German army in the Second World War. While inferior to the Garand and Lee-Enfield rifles it was up against, the fine construction of these rifles and their ingenious mechanism leaves the Mauser pattern as one of the most popular bolt-action rifles to this day."
