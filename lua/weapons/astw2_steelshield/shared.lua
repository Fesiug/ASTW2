...
SWEP.Purpose = "A steel body shield, for protecting the user from projectile attack. A narrow slit allows vision even when the shield is raised. This improvised shield was taken from the machine gun mount of a Humvee. It does not protect the lower body."
SWEP.Instructions = "ATTACK2 to raise shield. ATTACK1 to shield bash."

SWEP.ViewModel = nil
SWEP.WorldModel = "models/weapons/w_eq_steelshield.mdl"
