...
SWEP.Purpose = "A long multi-purpose digging tool. Purposes include smacking people about the head and digging their graves."
SWEP.Instructions = "ATTACK2 to aim. ATTACK1 to raise weapon, release to swing. Release ATTACK2 to cancel swing."

SWEP.ViewModel = nil
SWEP.WorldModel = "models/weapons/w_eq_shovel.mdl"
...
SWEP.Melee_Range = 64 // Range of the melee attack trace.
