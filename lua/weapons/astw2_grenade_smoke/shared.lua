...
SWEP.Purpose = "Grenade that disperses a smoke screen in order to obscure the enemy's line of sight. When NPCs are in the cloud, they will be unable to react until it is cleared."
...
SWEP.Projectile = "astw2_grenade_smoke_thrown"
