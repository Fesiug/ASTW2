...
SWEP.PrintName = "Mini Grenade"
SWEP.Category = "ASTW2 - Throwables"
SWEP.Slot = 4
SWEP.Author = "Arctic"
SWEP.Contact = "/id/ArcticWinterZzZ/"
SWEP.Purpose = "Ball-shaped grenade that can be thrown further than the Frag Grenade, but has a slightly smaller explosion and a shorter fuse."
SWEP.Instructions = "ATTACK2 to aim. Hold ATTACK1 to bring explosive up, release to throw/place. Release ATTACK2 to cancel."

SWEP.ViewModel = nil
SWEP.WorldModel = "models/weapons/w_eq_minigrenade.mdl"
...
SWEP.Projectile = "astw2_grenade_mini_thrown"
