...
SWEP.Purpose = "A broken glass beer bottle, for smashing people atop the head."
SWEP.Instructions = "ATTACK2 to aim. ATTACK1 to swing."

SWEP.ViewModel = nil
SWEP.WorldModel = "models/weapons/w_eq_bottle.mdl"
...
SWEP.Melee_Range_Forward = 2
SWEP.Melee_SwingTime = 0.25
SWEP.Melee_HitSound = "physics/glass/glass_bottle_impact_hard1.wav"
