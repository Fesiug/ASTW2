...
SWEP.PrintName = "Smoke Projector"
SWEP.Category = "ASTW2 - Special"
SWEP.Slot = 2
SWEP.Author = "Arctic"
SWEP.Contact = "/id/ArcticWinterZzZ/"
SWEP.Purpose = "Cut-down K98-based grenade launcher. Originally installed in tanks."
SWEP.Instructions = "ATTACK2 to aim, ATTACK1 to fire. Uses rifle smoke grenades."

SWEP.ViewModel = nil
SWEP.WorldModel = "models/weapons/w_gl_obrez.mdl"
...
SWEP.Primary.Ammo = "astw2_grenade_smoke"
SWEP.Primary.ClipSize = 1

SWEP.Projectile = "astw2_riflesmoke_launched"
