...
SWEP.PrintName = "Skillet"
SWEP.Category = "ASTW2 - Melee"
SWEP.Slot = 0
SWEP.Author = "Arctic"
SWEP.Contact = "/id/ArcticWinterZzZ/"
SWEP.Purpose = "A cast iron frying pan. Does not block bullets. Don't tell Bluehole we have this thing, or they'll sue us."
SWEP.Instructions = "ATTACK2 to aim. ATTACK1 to raise weapon, release to swing. Release ATTACK2 to cancel swing."

SWEP.ViewModel = nil
SWEP.WorldModel = "models/weapons/w_eq_skillet.mdl"
