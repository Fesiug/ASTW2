...
SWEP.PrintName = "Rejuvenative Smoke Grenade"
SWEP.Category = "ASTW2 - Throwables"
SWEP.Slot = 4
SWEP.Author = "Arctic"
SWEP.Contact = "/id/ArcticWinterZzZ/"
SWEP.Purpose = "A grenade able to disperse a fine nanite dust designed to help treat immediate wounds through means of nano-triage."
...
SWEP.Primary.Ammo = "astw2_grenade_regen_smoke"
SWEP.Primary.ClipSize = -1
SWEP.Primary.DefaultClip = 1

SWEP.Projectile = "astw2_grenade_r_smoke_thrown"
