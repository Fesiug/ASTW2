...
SWEP.Purpose = "Flash grenade, used to stun potential assailants before entry into a room through means of a bright flash and loud noise. Works on NPCs."
SWEP.Instructions = "ATTACK2 to aim. Hold ATTACK1 to bring explosive up, release to throw/place. Release ATTACK2 to cancel."

SWEP.ViewModel = nil
SWEP.WorldModel = "models/weapons/w_eq_stungrenade.mdl"
...
SWEP.Projectile = "astw2_grenade_flash_thrown"
