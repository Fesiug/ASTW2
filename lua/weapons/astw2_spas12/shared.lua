...
SWEP.Purpose = "Italian tube-fed semi-auto or pump-action shotgun; the SPAS-12 has a unique mechanism to allow it to switch between the two for one-handed use or specialty round insertion."
