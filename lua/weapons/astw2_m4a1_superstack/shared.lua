...
SWEP.PrintName = "M4A1 Tacstacked Mags"
SWEP.Category = "ASTW2 - Carbines"
SWEP.Slot = 3
SWEP.Author = "Arctic"
SWEP.Contact = "/id/ArcticWinterZzZ/"
SWEP.Purpose = "Yeah, the store had a surplus of these dual magazine kits and they were selling them off a dollar each. Did you know you can chain those things together?"
SWEP.Instructions = "ATTACK2 to aim, ATTACK1 to fire. Uses 5.56mm ammo."

SWEP.ViewModel = nil
SWEP.WorldModel = "models/weapons/w_rif_m4a1_superstack.mdl"
