...
SWEP.Purpose = "A grenade on a stick. The added leverage allows the grenade to be thrown further than a normal grenade."
SWEP.Instructions = "ATTACK2 to aim. Hold ATTACK1 to bring explosive up, release to throw/place. Release ATTACK2 to cancel."

SWEP.ViewModel = nil
SWEP.WorldModel = "models/weapons/w_eq_stickgrenade.mdl"
...
SWEP.Projectile = "astw2_grenade_stick_thrown"
