...
SWEP.Purpose = "He's hackin' and whackin' and smackin', he's hackin' and whackin' and smackin', he just hacks, smacks, choppin' that meat!"
SWEP.Instructions = "ATTACK2 to aim. ATTACK1 to raise weapon, release to swing. Release ATTACK2 to cancel swing."

SWEP.ViewModel = nil
SWEP.WorldModel = "models/weapons/w_eq_cleaver.mdl"
...
SWEP.Melee_Range = 26 // Range of the melee attack trace.
