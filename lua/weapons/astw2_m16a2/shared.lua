...
SWEP.Purpose = "Improved version of the M16A1, with a redesigned upper receiver and new handguard, as well as standard 30-round magazines. Fires 3-round bursts."
SWEP.Instructions = "ATTACK2 to aim, ATTACK1 to fire. Uses 5.56mm ammo."

SWEP.ViewModel = nil
SWEP.WorldModel = "models/weapons/w_rif_m16a2.mdl"
