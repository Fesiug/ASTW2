...
SWEP.Purpose = "A 'modernized' compact version of the M4 assault rifle. A 'flat top' railed receiver allows for the attachment of RIS sights. Its lightweight, modern construction offers improved accuracy at the cost of recoil control."
SWEP.Instructions = "ATTACK2 to aim, ATTACK1 to fire. Uses 5.56mm ammo."

SWEP.ViewModel = nil
SWEP.WorldModel = "models/weapons/w_rif_hk416.mdl"

SWEP.Primary.Damage = 18
SWEP.Primary.Delay = 60 / 700
SWEP.Primary.Acc = 1 / 185
SWEP.Primary.Recoil = 105
...
SWEP.MuzzlePosOverride = Vector(1, 32, -8)
