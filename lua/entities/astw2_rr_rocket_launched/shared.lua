...
function ENT:Detonate()
    if SERVER then
        ...
        util.BlastDamage(self, attacker, self:GetPos(), 128, 375)
...
function ENT:Draw()
    if CLIENT then
        ...
        cam.Start3D() -- Start the 3D function so we can draw onto the screen.
            ...
            render.DrawSprite( self:GetPos(), math.random(100, 200), math.random(100, 200), Color(255, 150, 50) ) -- Draw the sprite in the middle of the map, at 16x16 in it's original colour with full alpha.
        cam.End3D()
    end
end